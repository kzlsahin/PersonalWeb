...
function updateDataBuffer() {
    ...
    localStorage.setItem('lastDataState', JSON.stringify(dataBuffer));
...
function checkLocalstorage() {
    let lastRecord = localStorage.getItem('lastDataState');
    if (lastRecord) {
