...
class Pendulum extends React.Component {
    ...
    initValues() {
        ...
        for (let i = 0; i < wsNumber; i++) {
            this.state.tables.push(<PendulumTable key={"pend-" + this.props.pendnum + "-ws-" + (i + 1)} pendnum={this.props.pendnum} wsnum={i + 1} />)
        }
