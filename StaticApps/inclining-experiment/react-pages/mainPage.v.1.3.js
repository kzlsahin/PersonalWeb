...
window.addEventListener('load', () => { setInterval(updateTimestamp, 1000); console.log('time start'); setTimeout(checkLocalstorage, 500); });
window.addEventListener('beforeunload', updateDataBuffer);
